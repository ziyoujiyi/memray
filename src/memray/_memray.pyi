...
from memray._metadata import CpuMetadata
...
CpuSnapshot = NamedTuple("CpuSnapshot", [("time", int)])

def set_log_level(level: int) -> None: ...

class CpuSampleRecord:
    @property
    def address(self) -> int: ...
    @property
    def allocator(self) -> int: ...
    @property
    def n_cpu_samples(self) -> int: ...
    @property
    def size(self) -> int: ...
    @property
...
class FileReader:
    ...
    def get_cpu_snapshots(self) -> Iterable[CpuSnapshot]: ...
